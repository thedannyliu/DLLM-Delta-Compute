...
echo "Testing Phase A (Heuristic Caching) with 10 samples on V100"
...
# Phase A (L2C-FFN with heuristic schedule)
echo ""
...
echo "Phase A test completed at $(date)"
