...
TRACE_DIR="/home/hice1/eliu354/scratch/Projects/DLLM-Delta-Compute/experiments/P1_traces/traces_500_$(date +%Y%m%d_%H%M%S)"
...
python -m lm_eval \
    ...
    --batch_size 1 \
    --limit 500 \
    --output_path results/P1_500_$(date +%Y%m%d_%H%M%S)
