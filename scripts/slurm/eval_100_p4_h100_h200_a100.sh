#!/bin/bash
#SBATCH --job-name=eval_p4_100_a100_h200_h100
#SBATCH --account=coc
...
TIMING_LOG="/home/hice1/eliu354/scratch/Projects/DLLM-Delta-Compute/reports/timing/P4_100_${RUN_ID}.json"
...
python -m lm_eval \
    ...
    --batch_size 1 \
    --limit 100 \
    --output_path results/P4_100_${RUN_ID}
